...
//       setForm({ ...EMPTY, plantName: '' }); // Reset form, let them pick plant again
//     } catch (e) {
...
//         <p>Log a driver-behaviour observation. HR &amp; Safety for the selected plant are notified automatically.</p>
//       </div>

//       <div className="form-card">
//         <div className="field">
//           <label>Plant Location</label>
//           <select value={form.plantName} onChange={(e) => setForm({ ...EMPTY, plantName: e.target.value })}>
...
//         {/* Datalists for custom autocomplete with free-text allowed */}
...
const EMPTY = {
  ...
  routeLoc: '',
  cabNo: '',
  behaviorType: '', // Added behaviorType here
  driverName: '',
  description: '',
};
  ...
  return (
    <div className="page">
      ...
      <div className="form-card">
        ...
        {/* Grouped Driver Name and Driver Behavior together to keep your grid layout neat */}
        <div className="grid-2">
          <div className="field">
            <label>Driver Name</label>
            <input value={form.driverName} onChange={(e) => set('driverName', e.target.value)} placeholder="Driver's name (Optional)" />
